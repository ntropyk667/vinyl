...
extension VinylPreset {
    ...
    static let needleDrop = VinylPreset(id:"needledrop", name:"needle drop", description:"stylus mechanics, physical feel", params:{ var p = VinylParameters(); p.wear=20; p.masterIntensity=40; p.wowDepth=20; p.flutter=20; p.warpWow=20; p.speedDrift=20; p.trackingWeight=35; p.crackle=80; p.hiss=50; p.rumble=30; p.pressedNoise=20; p.hfRolloff=25; p.saturation=30; p.riaaVariance=25; p.stereoWidth=75; p.innerGrooveDistortion=65; p.azimuthError=45; p.roomResonance=20; p.airRolloff=p.hfRolloff; p.microphonics=p.roomResonance; p.speakerCoupling=p.roomResonance; p.outputTransformer=p.rumble; p.classADrive=p.saturation; return p }())
