...
class VinylEngine: ObservableObject {
    ...
    func updateNoiseParams() {
        ...
        if !hissDelayActive {
            // Hiss gain: raised from the inaudible 0.18 and then tuned by ear to
            // 0.35 (0.7 was about 2x too strong). Sits in the audible range with
            // crackle (0.63) and rumble (0.36). Keep in sync with offHiss in the
